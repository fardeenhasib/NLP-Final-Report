...
from transformers import (WEIGHTS_NAME, BertConfig, BertForSequenceClassification, BertTokenizer, BertModel,BertForMaskedLM,
                                  ...
                                  XLNetConfig, XLNetForSequenceClassification, XLNetTokenizer, AutoModelForCausalLM,
                                  RobertaConfig, RobertaForSequenceClassification, RobertaTokenizer, LongformerForMaskedLM, LongformerTokenizer,
                                  AlbertConfig, AlbertForSequenceClassification, AlbertTokenizer, AlbertModel,AlbertForMaskedLM, AutoModelForPreTraining,
...
args = {
    'data_dir': 'data/',
    'model_type':  'pairsupconbert',#'albert'
    'model_name': "aws-ai/pairsupcon-bert-base-uncased", #'albert-xxlarge-v2' "microsoft/BiomedNLP-PubMedBERT-base-uncased-abstract" 'bert-base-uncased' MoritzLaurer/DeBERTa-v3-small-mnli-fever-docnli-ling-2c MoritzLaurer/DeBERTa-v3-small-mnli-fever-docnli-ling-2c xlnet-base-cased
    'task_name': 'binary',
...
MODEL_CLASSES = {
    ...
    'xlnet': (XLNetConfig, AutoModelForCausalLM, XLNetTokenizer),
    'xlm': (XLMConfig, XLMForSequenceClassification, XLMTokenizer),
    'roberta': (RobertaConfig, RobertaForSequenceClassification, RobertaTokenizer),
    'albert': (AlbertConfig, AlbertForMaskedLM, AlbertTokenizer), #AlbertForSequenceClassification
    'pubmedbert': (AutoConfig, BertForMaskedLM, AutoTokenizer),
    'bioelectra' : (AutoConfig, AutoModelForMaskedLM, AutoTokenizer),
    'deberta' : (AutoConfig, AutoModelForMaskedLM, AutoTokenizer),
    'longformer' : (AutoConfig, LongformerForMaskedLM, LongformerTokenizer),
    'pairsupconbert': (AutoConfig, AutoModelForMaskedLM, AutoTokenizer),
}
